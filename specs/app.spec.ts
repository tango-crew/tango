...
import {it, describe, expect, beforeEach, beforeEachProviders, setBaseTestProviders, inject} from 'angular2/testing';
import {IonicApp, Platform, Events, NavController, Storage, LocalStorage} from 'ionic-angular';
import {TangoApp } from './../app/app';
import {AuthenticationPage} from './../app/pages/authentication/authentication'
import {ProfilePage} from './../app/pages/profile/profile'
import {FacebookService} from './../app/services/facebook';
